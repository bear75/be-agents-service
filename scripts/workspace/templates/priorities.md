...
1. **Shared Markdown Workspace Setup** — Set up the Mac mini: initialize workspace on iCloud, configure Telegram-only bot (WhatsApp removed — do not re-enable), load LaunchD plists, test end-to-end messaging flow.
