...
const DB_PATH = (() => {
  ...
  if (!override) {
    return path.join(SERVICE_ROOT, '.compound-state/agent-service.db');
  }
...
/**
 * Update a task (description, priority, etc.)
 */
function updateTask(taskId, updates) {
  ...
  // If status was updated to completed/failed, update agent stats
