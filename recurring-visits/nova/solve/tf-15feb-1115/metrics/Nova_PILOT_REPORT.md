...
All outputs under `docs_2.0/recurring-visits/nova/`. Reference run: **solve/tf-14feb-2200/**.

| Artefact               | Path (under `nova/`)                                                                    |
| ---------------------- | ---------------------------------------------------------------------------- |
| **Initial solve**      | `solve/tf-14feb-2200/export-field-service-routing-595776f0-*-output.json`             |
| **From-patch payload** | `solve/tf-14feb-2200/from-patch/payload_595776f0.json`                                |
| **Final schedule**     | `solve/tf-14feb-2200/from-patch/output_595776f0.json` (plan `c8e1708c-...`)             |
| **Metrics JSON**       | `solve/tf-14feb-2200/metrics/metrics_20260215_053038_c8e1708c.json`                  |
| **Metrics report**     | `solve/tf-14feb-2200/metrics/metrics_report_c8e1708c.txt`                            |

**tf-15feb-1115:** Same run; input, outputs, and metrics in `solve/tf-15feb-1115/` (including `metrics_report_595776f0.txt`, `metrics_report_c8e1708c.txt`).

Pipeline (expand → solve → from-patch → metrics) can be re-run with scripts in **`../huddinge-package/scripts/`**; see Nova README.
