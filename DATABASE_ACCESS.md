...
**Database Location:**
```bash
/Users/bjornevers_MacPro/HomeCare/be-agent-service/.compound-state/agent-service.db
```
...
**Yes, you can use TablePlus!**

1. **Open TablePlus**
2. **Create New Connection**
   - Click "+" or "Create a new connection"
   - Select **SQLite**
3. **Configure Connection:**
   - **Name:** Agent Service DB
   - **Database Path:** `/Users/bjornevers_MacPro/HomeCare/be-agent-service/.compound-state/agent-service.db`
   - Click **Connect**
