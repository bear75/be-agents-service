...
CREATE TABLE IF NOT EXISTS schedule_runs (
    ...
    unassigned_pct REAL,
    continuity_avg REAL,
    continuity_median REAL,
    continuity_visit_weighted_avg REAL,
    continuity_max INTEGER,
    continuity_over_target INTEGER,
    continuity_target INTEGER DEFAULT 11,
    input_shifts INTEGER,
    input_shift_hours REAL,
    output_shifts_trimmed INTEGER,
    output_shift_hours_trimmed REAL,
    shift_hours_total REAL,
    ...
    eff_v2_pct REAL,
    idle_shifts_v2 INTEGER,
    idle_shift_hours_v2 REAL,
